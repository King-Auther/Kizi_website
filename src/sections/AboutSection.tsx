...
import pinkModel from '../assets/KIZI_MODEL_PINK-opt.webp';
import blazerModel from '../assets/KIZI_MODEL_BLAZER-opt.webp';
import coOrdModel from '../assets/KIZI_MODEL_CO-ORD_SET-opt.webp';
import orangeModel from '../assets/KIZI_MODEL_ORANGE-opt.webp';
            ...
            {imageLinks.map((img, idx) => (
              ...
              >
                <OptimizedImage
                  src={img.src}
                  alt={img.alt}
                  className="w-full h-auto object-contain transition-transform duration-300 group-hover:scale-105 group-hover:brightness-90 cursor-pointer"
                />
              </a>
            ))}
          </div>
