                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <div className="flex space-x-4 mt-2">
                          <a href="https://www.instagram.com/kiziapparels/" className="text-gray-600 hover:text-primary-600">
                          ...
                          <a href="https://www.facebook.com/Kiziapparels" className="text-gray-600 hover:text-primary-600">
                            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
