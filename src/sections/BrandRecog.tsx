...
import brandImage from '../assets/brand_recog/brand.webp';
import { FASHION_FEATURE_IMAGE, PEXELS_PORTRAIT_A, PEXELS_PORTRAIT_B } from '../constants/images';
