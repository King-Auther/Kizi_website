...
const InvestorPortal: React.FC = () => {
  ...
  const calendarEvents: { date: string; name: string; attachment?: string }[] = [
    ...
    {
      date: '2026-05-11',
      name: 'Board Meeting: Outcome of Board Meeting',
      attachment: '/pdf_links/Outcome of Board Meeting_11052026_SD.pdf'
    },
    {
      date: '2025-05-28',
  ...
  const scrutinizerReports: { name: string; date: string; size: string; url: string }[] = [
    ...
    },
    {
      ...
      date: '2026',
      size: 'PDF',
      url: '/pdf_links/Scrutiniser_report._SD.pdf'
    }
  ];
          ...
          <div className="lg:col-span-3">
            ...
            {activeTab === 'announcements' && (
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-6">
                  {/* Announcement: Outcome of Board Meeting (11-May-2026) */}
                  <div className="border rounded-lg p-4 shadow hover:bg-gray-50 transition">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 mb-2">
                      <span className="font-bold text-primary-900 text-lg">Outcome of Board Meeting (11-May-2026)</span>
                      <span className="inline-block bg-purple-100 text-purple-800 text-xs font-semibold px-2 py-1 rounded">Board Meeting</span>
                    </div>
                    <div className="text-gray-700 mb-2">Outcome of the Board Meeting held on May 11, 2026.</div>
                    <div className="text-xs text-gray-500 mb-2">Published: May 2026</div>
                    <div className="flex items-center gap-4">
                      <a href="/pdf_links/Outcome of Board Meeting_11052026_SD.pdf" className="flex items-center text-red-600 hover:underline text-sm" target="_blank" rel="noopener noreferrer">
            ...
            {activeTab === 'notices' && (
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="border rounded-lg p-4 shadow hover:bg-gray-50 transition">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 mb-2">
                      <span className="font-bold text-primary-900 text-lg">Corrigendum to Notice</span>
                      <span className="inline-block bg-blue-100 text-blue-800 text-xs font-semibold px-2 py-1 rounded">Notice</span>
                    </div>
                    <div className="text-gray-700 mb-2">Corrigendum to the earlier issued notice.</div>
                    <div className="flex items-center gap-4">
                      <a
                        href="/pdf_links/CORRIGENDUM TO NOTICE (1).pdf"
                        className="flex items-center text-red-600 hover:underline text-sm"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
